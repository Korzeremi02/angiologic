...
export default function Home() {
  ...
  <div className="flex flex-col h-screen w-screen">
    ...
    <aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/draw" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white bg-gray-600 dark:hover:bg-gray-700 group">
    ...
    <div class="p-4 sm:ml-64 flex flex-col h-screen w-min-fit">
      <div class="p-4 h-4/5 border-2 w-full border-gray-200 border-dashed rounded-lg dark:border-gray-700">
        <canvas class="h-full w-full bg-red-500"></canvas>
      </div>
      <div class="p-4 h-1/5 w-full border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-6">
