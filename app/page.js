  ...
  <div className="flex flex-col h-screen w-screen bg-black">
    ...
    <div class="p-4 sm:ml-64">
      <div class="p-4 border-2 h-auto border-gray-200 border-dashed rounded-lg">
          ...
          <p class="w-11/12 text-base font-normal text-white text-left leading-none"><br />Pour commencer,<br />Cliquer sur la section <b>Fichiers</b> pour importer ou créer un nouveau fichier patient.</p>
      </div>
      <div class="p-4 my-3 border-2 h-auto border-gray-200 border-dashed rounded-lg">
