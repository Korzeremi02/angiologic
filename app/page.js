    ...
    <aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white bg-gray-600 dark:hover:bg-gray-700 group">
                  <img src={svgHome} class="w-5 h-5" aria-hidden="true"></img>
                  <span class="ms-3">Accueil</span>
                </a>
            </li>
            <li>
                <a href="/file" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
