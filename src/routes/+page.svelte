...
<!-- 
  <script>
    ...
    onMount(() => {
    imgStyle = `width: ${window.innerWidth}px`;
    });
</script>
...
<main>
    <div class="App">
        <div class="App-Title">
            <p class="App-Title-Text">Medic</p>
        </div>
        <div class="App-Body">
            <div class="carousel">
                <button on:click={previousImage}>Previous</button>
                <img style={imgStyle} src={images[currentImageIndex]} />
                <button on:click={nextImage}>Next</button>
            </div>
            <div class="validation">
                <button on:click={goToEditor}>Valider</button>	
            </div>
        </div>
    </div>    
</main> -->